...
func request_SampleService_Unary_0(ctx context.Context, marshaler runtime.Marshaler, client SampleServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterSampleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SampleServiceClient) error {
	...
	mux.Handle("GET", pattern_SampleService_Unary_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_SampleService_Unary_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_SampleService_Unary_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_SampleService_Unary_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "example", "echo", "msg"}, ""))
)

var (
	forward_SampleService_Unary_0 = runtime.ForwardResponseMessage
)
