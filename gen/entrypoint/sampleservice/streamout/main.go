...
import (
	...
	impl "github.com/mattmoor/korpc-sample/pkg/methods/sampleservice/streamout"
)
...
func (s *server) StreamOut(input *pb.Request, stream pb.SampleService_StreamOutServer) error {
